    ...
    ""maps"": [
        {
            ...
            ""id"": ""974ee3b6-6c18-4cdd-955c-3877b4298f23"",
            ""actions"": [
                {
                    ""name"": ""CameraLook"",
                    ""type"": ""Value"",
                    ""id"": ""b06cedb8-d59d-45a3-8343-8c00368b6e77"",
                ...
                },
                {
                    ""name"": ""PlayerMove"",
                    ""type"": ""Value"",
                    ""id"": ""e38262f4-73a8-47a1-87ff-a73e530b4b29"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""8a90d478-4555-4e06-bc4d-19801ef7bc66"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                ...
                {
                    ""name"": ""WASD Keys"",
                    ""id"": ""718a44cf-0c56-4840-8ca1-c3881ab42eb2"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""0312dafe-ad08-4f3d-8a67-62b535b10848"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard and Mouse"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""75190d01-22e7-4451-b9e8-8645b6ef8c24"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard and Mouse"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""63e60ffc-f459-4378-b248-d484968cf963"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard and Mouse"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""bb5f5d76-828f-4d3a-84c1-183803f1bed3"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard and Mouse"",
                ...
                {
                    ""name"": ""Arrow Keys"",
                    ""id"": ""77dbf93f-abfa-4696-b2b4-7932b6d36629"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""7da928dd-b59a-4f8b-97fd-aa0c3c954394"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""e14db946-f686-430f-a4b4-6cf32429ff42"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""cbb9fe2d-001e-4f14-8d2f-27c525f3609f"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""49aed9ee-95e3-41cd-8662-5cf2e55ee27f"",
